...
def resnet18(pretrained=False, **kwargs):
    """Constructs a ResNet-18 model Encoder"""
...
def resnet34(pretrained=False, **kwargs):
	"""Constructs a ResNet-34 model Encoder"""
...
def resnet101(pretrained=False, **kwargs):
	"""Constructs a ResNet-101 model Encoder"""
...
def resnet152(pretrained=False, **kwargs):
	"""Constructs a ResNet-152 model Encoder"""
	model = ResNet(Bottleneck, [3, 8, 36, 3], **kwargs)
	if pretrained:
		model.load_state_dict(
			model_zoo.load_url("https://download.pytorch.org/models/resnet152-b121ed2d.pth")
		)
	return model
