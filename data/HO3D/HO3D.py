...
from utils.vis import save_obj, vis_keypoints, vis_keypoints_with_skeleton, vis_mesh
...
class HO3D(torch.utils.data.Dataset):
    ...
    def load_data(self):
        ...
        for aid in db.anns.keys():
            ...
            if self.data_split == "train":
                ...
                joints_coord_img = cam2pixel(
                    joints_coord_cam, cam_param["focal"], cam_param["princpt"]
                )
                bbox = get_bbox(
                    joints_coord_img[:, :2],
    ...
    def __getitem__(self, idx):
        ...
        img, img2bb_trans, bb2img_trans, rot, scale = augmentation(
            img, bbox, self.data_split, do_flip=False
        )
    ...
    def evaluate(self, outs, cur_sample_idx):
        ...
        for n in range(sample_num):
            ...
            joints_out = transform_joint_to_other_db(
                joints_out, mano.joints_name, self.joints_name
            )
